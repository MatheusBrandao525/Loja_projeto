...
<div class="container-fluid">
	...
	<div class="row" style="margin-top: 15px;">
		...
		<div class="col-sm-1 col-sm-offset-1"><img src="imagens/<?php echo $exibir['ds_capa']; ?>.jpg" class="img-responsive"></div>
		<div class="col-sm-5"><h4 style="padding-top:20px"><?php echo $exibir['nm_produto'];?></h4></div>
		<div class="col-sm-2"><h4 style="padding-top:20px"> R$ <?php echo number_format($exibir['vl_preco'],2,',','.'); ?></h4></div>

       
		<div class="col-sm-2 col-xs-offset-right-1" style="padding-top:20px">
        <a href="detalhes.php?cd=<?php echo $exibir['cd_produto'];?>">
