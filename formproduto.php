...
<head>
<meta charset="utf-8">
<title>Minha Loja - Cadastrar produtos</title>
...
<?php
	...
	session_start();
    	...
    	// se a sessão id estiver vazia ou se a sessão estatus for diferente de adm então execute
			...
			<div class="col-sm-4 col-sm-offset-4">
				...
				<form method="post" action="insprod.php" name="incluiProd" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<label for="txtisbm">Marca</label>
						<input name="txtisbm" type="text" class="form-control" required id="txtisbm">
					</div>
